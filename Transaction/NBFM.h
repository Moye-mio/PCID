...
private:
	...
	void __calcTransform(const PC_t::Ptr vCloud, const core::SCube& t, const core::SCube& s, Eigen::Matrix3f& voRotation, vec3f& voTranslation);
	PC_t::Ptr __calcTransfromBasedOnICP(const PC_t::Ptr vCloud, const core::SCube& t, const core::SCube& s);
